...
Size _calendarPortraitDialogSize = Size(SystemTheme.scale(500.0), SystemTheme.scale(421.0));
const Size _calendarLandscapeDialogSize = Size(496.0, 346.0);
Size _inputPortraitDialogSize = Size(SystemTheme.scale(400.0), SystemTheme.scale(421.0)); //Size(330.0, 270.0);
...
Future<DateTime?> showSynergyDatePicker({
...
class _DatePickerDialogState extends State<DatePickerDialog>
      ...
      case DatePickerEntryMode.calendarOnly:
        switch (orientation) {
          case Orientation.portrait:
            return Size(SystemTheme.scale(400), SystemTheme.scale(500));
  ...
  Widget build(BuildContext context) {
    ...
    final String dateText = "${localizations.formatMediumDate(_selectedDate.value)}A";
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: Container(
                decoration: BoxDecoration(
                  border: Border.all(color: AppColor.enabledColor,),
                  borderRadius: BorderRadius.circular(8),
                ),
                padding: EdgeInsets.all(SystemTheme.scale(7)),
                width: SystemTheme.scale(90),
                alignment: Alignment.center,
                child: AppText(
                  title: widget.cancelText ?? localizations.cancelButtonLabel,
          ...
          GestureDetector(
            ...
            child: Container(
                ...
                alignment: Alignment.center,
                child: AppText(
                  title: widget.confirmText ?? localizations.okButtonLabel,
    ...
    final Size dialogSize = _dialogSize(context) * (textScaleFactor - 0.2);
    return Container(
      width: SystemTheme.width,
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(SystemTheme.scale(20)),
      ),
      child: Dialog(
        insetPadding:  EdgeInsets.symmetric(horizontal: SystemTheme.scale(10), vertical: SystemTheme.scale(10)),
        clipBehavior: Clip.antiAlias,
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(SystemTheme.scale(20)))),
          ...
          child: MediaQuery(
            ...
            child: Builder(builder: (BuildContext context) {
              switch (orientation) {
                case Orientation.portrait:
                  return Padding(
                    padding:  EdgeInsets.only(bottom: SystemTheme.scale(10)),
                    child: Column(
...
class _CalendarDatePickerState extends State<CalendarDatePicker> {
  ...
  Widget build(BuildContext context) {
    ...
    assert(debugCheckHasMaterialLocalizations(context));
    assert(debugCheckHasDirectionality(context));
    var my = _localizations.formatMonthYear(_currentDisplayedMonthDate);
    var m = my.indexOf(' ');
    var month = '${my.substring(0,m).substring(0, 3).trim()} ${my.substring(m+1)}';
    return Padding(
      padding:  EdgeInsets.fromLTRB(SystemTheme.scale(20), SystemTheme.scale(30),
          SystemTheme.scale(20),0),
      child: Stack(
        children: <Widget>[
          SizedBox(
          ...
          _DatePickerModeToggleButton(
            mode: _mode,
            title: month, //_localizations.formatMonthYear(_currentDisplayedMonthDate),
            // title: DateFormat('MM yyyy').format(_currentDisplayedMonthDate),
            onTitlePressed: () {
                      ...
                      children: <Widget>[
                        Flexible(
                          child: AppText(
                            ...
                            fontSize: 14,textColor: AppColor.color333333,
...
DateTime? of(BuildContext context) {
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color selectedDayColor = AppColor.white;// colorScheme.onPrimary;
      ...
      if (day < 1) {
        ...
        if (isSelectedDay) {
          ...
          decoration = const BoxDecoration(
            color: AppColor.enabledColor, // Theme.of(context).primaryColor,
            shape: BoxShape.circle,
          );
        } else if (isDisabled) {
        ...
        Widget dayWidget = Container(
          ...
          child: Center(
            child: Text(
                ...
                style: dayStyle.apply(color: dayColor, fontFamily: FontEnum.GMedium.toString(),
                ),),
          ),
        );
